...
const navigation: any[] = [
  { name: 'Events', href: '/events', display: true },
  // { name: "Calendar", href: "//calendar", display: true },
  { name: 'Settings', href: '/settings', display: true },
];
      ...
      <div className="bg-primary dark:bg-primary-dark pb-32">
        ...
        <header className="py-10">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <h1 className="text-3xl font-bold tracking-tight dark:text-gray-100 text-zinc-900">
