...
export function Sidebar({ className, ...props }: React.ComponentPropsWithoutRef<'nav'>) {
  return <nav {...props} className={cx(className, 'flex h-full min-h-0 flex-col')} />;
}
...
export function SidebarSection({ className, ...props }: React.ComponentPropsWithoutRef<'div'>) {
  ...
  return (
    <LayoutGroup id={id}>
      <div {...props} data-slot="section" className={cx(className, 'flex flex-col gap-0.5')} />
    </LayoutGroup>
  );
}
...
export function SidebarDivider({ className, ...props }: React.ComponentPropsWithoutRef<'hr'>) {
  return (
    <hr
      {...props}
      className={cx(className, 'my-4 border-t border-zinc-950/5 dark:border-white/5 lg:-mx-4')}
    />
  );
}
